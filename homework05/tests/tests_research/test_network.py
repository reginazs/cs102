...
class EgoNetworkTestCase(unittest.TestCase):
    ...
    def test_network(self):
        ...
        responses.add(
            ...
            json={
                "response": [
                    {"id": 1, "common_friends": [2, 3], "common_count": 2},
                    {"id": 2, "common_friends": [1, 3, 4], "common_count": 3},
                    {"id": 3, "common_friends": [1, 2], "common_count": 2},
                    {"id": 4, "common_friends": [2], "common_count": 1},
                    {"id": 5, "common_friends": [], "common_count": 0},
                ]
            },
            status=200,
        )
